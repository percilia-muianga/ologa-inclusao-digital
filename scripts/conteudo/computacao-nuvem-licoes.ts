  ...
  m2l2: {
    ...
    laboratorio: {
      ...
      passos: [
        ...
        "Só agora criar a máquina virtual Linux, com os dados da ficha de preparação, escolhendo explicitamente a rede virtual criada e a sub-rede aplicacao, com endereço público atribuído e SEM permitir portas de entrada no assistente — a filtragem já vem do grupo de segurança da sub-rede.",
        ...
        "Teste negativo por avaliação de regras: na interface de rede da máquina, abrir a verificação de fluxo do próprio portal e avaliar dois casos — entrada na porta 22 a partir de um endereço qualquer da internet, que deve resultar em negado com indicação da regra 4000, e entrada na porta 5432 vinda da sub-rede de aplicação para a sub-rede de dados, que deve resultar em permitido pela regra 100.",
        "Registar na ficha o resultado de cada avaliação, com o nome da regra que decidiu, e não apenas «não liguei».",
      ],
      verificacao: [
        ...
        "Nenhuma regra tem origem «qualquer» ou 0.0.0.0/0 numa porta administrativa; confirma-se lendo a coluna de origem de todas as regras de entrada.",
      ],
      problemas: [
      ...
      evidencia: [
        ...
        "Captura de ecrã do resultado da avaliação de fluxo, nos dois casos, com a regra que decidiu.",
    ...
    guiao: {
      ...
      criterios: [
        ...
        "Existem teste positivo e teste negativo documentados, este último com a regra que decidiu.",
      ...
      errosComuns: [
        ...
        "Aceitar a abertura de porta proposta pelo assistente de criação da máquina.",
