...
export const LICOES: Record<string, ConteudoLicao> = {
  m1l1: {
    ...
    explicacao: [
      ...
      "Quanto à evolução: durante décadas cada instituição manteve a sua própria sala de servidores, com custo fixo e capacidade dimensionada para o pico. A virtualização permitiu correr várias máquinas lógicas num mesmo equipamento físico, aumentando o aproveitamento. Nos anos 2000, grandes operadores começaram a oferecer essa capacidade virtualizada a terceiros, medida e paga ao consumo. Seguiram-se os serviços geridos, em que o fornecedor trata também do sistema operativo, da base de dados ou da própria plataforma de aplicação, e mais recentemente a execução sem servidor visível, em que só se paga o tempo de execução do código. A direcção é sempre a mesma: menos infra-estrutura para gerir e mais atenção ao serviço prestado.",
