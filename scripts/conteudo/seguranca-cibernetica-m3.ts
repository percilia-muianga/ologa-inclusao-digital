...
const M3L4: ConteudoLicao = {
  ...
  explicacao: [
    ...
    "O relatório final não é burocracia: é o que permite à instituição aprender e responder a quem pergunta. Duas páginas chegam, desde que tenham cronologia, factos separados de hipóteses, evidência com custódia, decisões com fundamento, estado final e recomendações com responsável e prazo.",
  ],
  exemplo: {
