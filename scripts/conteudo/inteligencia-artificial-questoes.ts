...
const M1L1: QuestaoIA[] = [
  {
    ...
    opts: [
      "O sistema estar instalado num servidor da própria instituição",
      "O sistema produzir, a partir das entradas que recebe, saídas como previsões ou recomendações que influenciam decisões",
      "O sistema ter sido comprado a um fornecedor internacional",
      "O sistema funcionar sem ligação à internet",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      ...
      "Porque trata poucos formulários por dia",
      "Porque não usa a internet",
      "Porque a decisão é sempre rejeitar",
    ], ind: 0,
  ...
  },
  {
    ...
    opts: [
      "Que a citação está correcta, porque o modelo foi treinado com documentos oficiais",
      "Que o texto é plausível na forma e que a referência tem de ser confirmada na fonte antes de ser usada",
      "Que o texto pode ser usado tal como está em documentos oficiais",
      "Que o modelo consultou a legislação no momento da resposta",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Uma folha de cálculo que soma automaticamente as colunas de um mapa mensal",
      "Um sistema de gestão documental que guarda ficheiros por pasta e data",
      "Um serviço que transcreve gravações de reuniões em texto, com taxa de erro variável conforme o sotaque",
      "Um sítio na internet que mostra os horários de atendimento",
    ], ind: 2,
  ...
  },
  {
    ...
    opts: [
      "A chefia tem razão: 192 em 240 é 80 por cento, acima dos três quartos exigidos",
      ...
      "O sistema deve ser desligado, porque errou 48 vezes",
      "Os dados são inconclusivos porque não se sabe quantos pedidos existiram",
    ], ind: 1,
...
const M1L2: QuestaoIA[] = [
  {
    ...
    opts: ["Registos", "Variáveis, ou atributos", "Modelos", "Algoritmos"], ind: 1,
  ...
  },
  {
    ...
    opts: [
      ...
      "O algoritmo é o equipamento onde o sistema corre; o modelo é o programa",
      "São a mesma coisa, com nomes diferentes conforme o fornecedor",
      "O modelo é o procedimento de treino; o algoritmo é o ficheiro final",
    ], ind: 0,
  ...
  },
  {
    ...
    opts: [
      "É irrelevante: 140 linhas são poucas num conjunto grande",
      "Deve preencher-se o distrito com o valor mais frequente, para não perder dados",
      ...
      "Devem apagar-se as 140 linhas, sem mais análise",
    ], ind: 2,
  ...
  },
  {
    ...
    opts: [
      "A coluna tem formato de data e o sistema só aceita números",
      ...
      "A coluna tem demasiados valores diferentes",
      "A coluna deve ser usada, porque melhora o resultado medido",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Nenhum: 1 200 registos são suficientes para qualquer utilização",
      ...
      "O sistema vai ficar lento por causa do número de registos de balcão",
      "O risco é apenas de protecção de dados, não de desempenho",
    ], ind: 1,
...
const M1L3: QuestaoIA[] = [
  {
    ...
    opts: [
      "Não têm qualquer informação sobre o resultado",
      "Têm, para cada exemplo, o resultado correcto já conhecido",
      "São gerados pelo próprio sistema",
      "São apenas números, nunca texto",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Dados em falta",
      "Erro de medição do conjunto de teste",
...
const M1L4: QuestaoIA[] = [
  {
    ...
    opts: [
      "Enviar directamente, indicando que o texto foi gerado automaticamente",
      "Comparar o resumo com a acta original e corrigir o que não corresponder, assumindo a responsabilidade pelo texto assinado",
      "Pedir um segundo resumo ao mesmo assistente e comparar os dois",
      "Enviar e corrigir depois, se alguém reclamar",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Escrever a instrução em inglês, mesmo que o documento seja em português",
      "Indicar o objectivo, o destinatário, o comprimento pretendido e o que não deve ser inventado",
      "Pedir o texto mais longo possível, para depois cortar",
      "Repetir a mesma instrução várias vezes seguidas",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "A ferramenta ser a mais recente do mercado",
      ...
      "A ferramenta ter interface em português",
      "A ferramenta ser usada por outra instituição do mesmo sector",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Pedir aos participantes que usem contas pessoais para completar o exercício",
      "Usar a saída simulada para a análise e registar que a prática com ferramenta real fica por executar, a reagendar",
      "Dar o exercício por cumprido, porque a análise foi feita",
      "Substituir o exercício por uma exposição teórica e não registar nada",
    ], ind: 1,
...
const M2L1: QuestaoIA[] = [
  {
    ...
    opts: [
      "Decidir o resultado do pedido",
      "Propor um encaminhamento e assinalar informação em falta, cabendo a decisão a quem tem competência para decidir",
      "Substituir o registo de entrada dos pedidos",
      "Arquivar automaticamente os pedidos incompletos",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Falha do sistema de inteligência artificial",
      "Falha de aplicação da regra por quem executa a triagem",
      "Falha de protecção de dados",
  ...
  },
  {
    ...
    opts: [
      "Comparar duas ferramentas de inteligência artificial entre si",
      ...
      "Comparar o tempo de resposta do sistema com o de outra instituição",
      "Comparar o custo das licenças com o orçamento anual",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Não tem efeito sobre a pessoa, porque o erro é corrigível internamente",
      "Pode atrasar o processo e fazer a pessoa deslocar-se ao sector errado, mesmo sendo corrigível",
      "Obriga sempre ao arquivamento do pedido",
      "Impede a apresentação de um novo pedido",
    ], ind: 1,
...
const M2L2: QuestaoIA[] = [
  {
    ...
    opts: [
      ...
      "Guardar os dados durante o menor tempo tecnicamente possível",
      "Substituir os nomes por códigos em todos os documentos",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Ao sector que recolhe o dado",
      "Ao motivo concreto pelo qual o dado é necessário",
      "Ao prazo de conservação",
      "Ao formato em que o dado é guardado",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: ["Anonimização", "Pseudonimização", "Encriptação", "Agregação"], ind: 1,
  ...
  },
  {
    ...
    opts: [
      ...
      "Obter autorização escrita de cada pessoa titular dos dados",
      "Publicar a lista de registos a eliminar",
      "Nenhum: cumprido o prazo proposto, a eliminação é automática",
    ], ind: 0,
  ...
  },
  {
    ...
    opts: [
      "Os dois registos pertencem à mesma pessoa",
      ...
      "Os dois registos pertencem necessariamente a pessoas diferentes",
      "A combinação prova que o ficheiro está anonimizado",
    ], ind: 1,
...
const M2L3: QuestaoIA[] = [
  {
    ...
    opts: [
      "Uma variável sem valores em falta",
      "Uma variável que, não sendo o atributo em causa, está associada a ele e pode reproduzir a mesma diferença",
      "Uma variável calculada a partir de outras duas",
      "Uma variável que só existe no conjunto de teste",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Existe discriminação, no sentido jurídico do termo",
      ...
      "A diferença deve-se necessariamente à variável de grupo",
      "A diferença é irrelevante se a taxa global for boa",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Os grupos estão em igualdade, porque o grupo A tem mais erros em número absoluto",
      "A taxa de erro é de 10 por cento no grupo A e de 20 por cento no grupo B: em proporção, o grupo B é pior servido",
      "A taxa de erro é igual nos dois grupos",
      "Não é possível comparar, por os grupos terem dimensões diferentes",
    ], ind: 1,
...
const M2L4: QuestaoIA[] = [
  {
    ...
    opts: [
      "A pessoa poder ler as decisões do sistema depois de executadas",
      ...
      "A pessoa assinar um documento a confirmar que conhece o sistema",
      "A pessoa poder pedir ao fornecedor que altere o sistema",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Um endereço de correio electrónico genérico da instituição",
      ...
      "A publicação do código do sistema",
      "A indicação do fornecedor da tecnologia",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "É lei aplicável em Moçambique desde a sua publicação",
      ...
      "Nunca pode abranger entidades situadas fora da União Europeia",
      "Vincula Moçambique por ser uma recomendação internacional",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Aguardar pela reunião mensal do comité para propor a suspensão",
      ...
      "Continuar a encaminhar conforme o sistema indica, para não quebrar o procedimento",
      "Desligar o sistema sem informar ninguém",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Gravidade estimada e nome do fornecedor",
      "Responsável designado, acção concreta a executar e evidência que demonstra a execução",
      "Data de aquisição do sistema e orçamento anual",
      "Número de pedidos mensais e nome do sector",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      ...
      "Motivo da suspensão e assinatura do dirigente",
      "Identificação do fornecedor e cópia do contrato",
      "Data da suspensão e número de pedidos afectados",
    ], ind: 0,
...
const TRANSVERSAL: QuestaoIA[] = [
  {
    ...
    opts: [
      "Que o portal seja rápido em qualquer equipamento",
      "Que o serviço continue utilizável por pessoas com deficiência, com formatos e vias de acesso adequados",
      "Que o portal esteja disponível 24 horas por dia",
      "Que o portal tenha versão para telemóvel",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      ...
      "O direito à contratação pública",
      "O direito à estatística",
    ], ind: 0,
  ...
  },
  {
    ...
    opts: [
      "Avaliar a acessibilidade apenas depois da entrega, em fase de utilização",
      "Incluir requisitos de acessibilidade nas especificações e nos critérios de avaliação das propostas",
      "Deixar a acessibilidade a cargo do fornecedor, sem a especificar",
      "Aceitar compromissos verbais de acessibilidade do fornecedor",
    ], ind: 1,
  ...
  },
  {
    ...
    opts: [
      "Para aumentar o número de campos do formulário",
      "Para permitir identificar barreiras e diferenças de acesso que os totais escondem, com salvaguardas de protecção de dados",
      "Para tornar o atendimento mais rápido",
      "Para cumprir uma exigência dos fornecedores de tecnologia",
    ], ind: 1,
